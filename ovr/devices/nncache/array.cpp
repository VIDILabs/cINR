...
CreateArray1DScalarCUDA(array_1d_scalar_t input)
{
  ...
  case VALUE_TYPE_UINT16: output = CreateArray1DScalarCUDA<uint16_t>(input, input->data()); break;
  case VALUE_TYPE_INT16:  output = CreateArray1DScalarCUDA<int16_t >(input, input->data()); break;
  ...
  case VALUE_TYPE_DOUBLE: output = CreateArray1DScalarCUDA<double  >(input, input->data()); break;
  default: throw std::runtime_error("[nncache] unexpected array type ...");
  }
  return output;
}
...
CreateArray3DScalarCUDA(array_3d_scalar_t array)
{
  ...
  case VALUE_TYPE_UINT16: output = CreateArray3DScalarCUDA<uint16_t>(array->data(), array->dims); break;
  case VALUE_TYPE_INT16:  output = CreateArray3DScalarCUDA<int16_t >(array->data(), array->dims); break;
  ...
  case VALUE_TYPE_DOUBLE: output = CreateArray3DScalarCUDA<double  >(array->data(), array->dims); break;
  default: throw std::runtime_error("[nncache] unexpected volume type ...");
  }
